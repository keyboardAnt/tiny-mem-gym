"""Run a random policy in the sequence recall environment."""
...
def main() -> None:
    ...
    print("Running SequenceRecallEnv via direct construction")
    ...
    print("\nRunning SequenceRecallEnv via gymnasium.make")
    env = gym.make("TinyMem-SequenceRecall-v0")
    for episode in range(3):
        obs, info = env.reset(seed=episode)
        done = False
        total_reward = 0.0
